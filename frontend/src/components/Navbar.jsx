...
const Navbar = () => {
    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-dark shadow-sm mb-3 mb-md-4" style={{ background: 'linear-gradient(135deg, #1a1a2e 0%, #16213e 100%)' }}>
            <style>{`
            ...
            {/* Bottom Nav - Mobile */}
            <div className="d-md-none fixed-bottom bg-white d-flex justify-content-around align-items-center pb-2 pt-2" style={{ height: '65px', boxShadow: '0 -4px 12px rgba(0,0,0,0.06)', zIndex: 1050, borderTop: '1px solid #f1f5f9' }}>
